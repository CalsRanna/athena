...
@RoutePage()
class DesktopSettingProviderSiliconFlowPage extends StatelessWidget {
  const DesktopSettingProviderSiliconFlowPage({super.key});
            ...
            children: [
              ...
              Expanded(
                child: AInput(
                  ...
                  placeholder: 'https://SiliconFlow.ai/api/v1',
                ),
              )
            ],
          ),
