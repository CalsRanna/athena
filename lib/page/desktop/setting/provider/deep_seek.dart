...
@RoutePage()
class DesktopSettingProviderDeepSeekPage extends StatelessWidget {
  const DesktopSettingProviderDeepSeekPage({super.key});
            ...
            children: [
              ...
              Expanded(
                child: AInput(
                  ...
                  placeholder: 'https://DeepSeek.ai/api/v1',
                ),
              )
            ],
          ),
