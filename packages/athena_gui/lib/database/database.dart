...
import 'package:athena_gui/database/migration/migration_202606110001_dedup_presets.dart';
import 'package:athena_gui/database/migration/migration_202606170001_add_preset_flag.dart';
import 'package:athena_gui/database/migration/migration_202606230001_add_chat_token_total.dart';
import 'package:athena_gui/database/migration/migration_202606240001_context_window_to_int.dart';
...
import 'package:athena_gui/database/migration/migration_202609210001_add_chat_workspace_path.dart';
...
class Database {
  ...
  Future<void> _migrate() async {
    ...
    await Migration202609200002RequireToolCallDescription().migrate();
    await Migration202609210001AddChatWorkspacePath().migrate();
  }
