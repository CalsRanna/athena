/// 内置 Athena 预设 sentinel 的系统提示词:单一事实来源已移到
/// `athena_core/seed/athena_preset_prompt.dart`,此处转发供历史 migration 引用。
///
/// 本文件另保留两份**旧版**提示词,仅供升级 migration 判断用户是否仍在
/// 使用默认内容(通过 sentinel_evolve 进化过的内置 Athena 不应被覆盖):
/// - [agentAthenaPresetPromptV1]:`call_description` 转必填之前的 Agent 版
/// - [legacyAthenaPresetPrompt]:纯对话模式版
library;

export 'package:athena_core/seed/athena_preset_prompt.dart'
    show athenaPresetPrompt;
